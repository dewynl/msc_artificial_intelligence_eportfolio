        ...
        <>
				...
				<div style={{ display: 'flex' }}>
					<div style={{ flex: '50%', padding: 10 }}>
						<img
							src={require('./default_pearson.png')}
				...
				<>
					...
					<p>
						<a href={require('./clustering/peer_report_code.ipynb')}
					...
					<p>
						<a
							href={require('./clustering/group3_report.docx')}
				...
				<>
					...
					<p>
						<a href={require('./ann/Team_Presentation_Group_3_Transcript.pdf')} download={'Team_Presentation_Group_3_Transcript.pdf'}>
							Link to transcript
						</a>
					</p>
					<p>
						<a
							href={require('./ann/Team_Presentation_Group_3_Code.ipynb')} download={'Team_Presentation_Group_3_Code.pdf'}
						>
