			...
			<>
				...
				<div style={{ display: "flex" }}>
					<div style={{ flex: "50%", padding: 10 }}>
						<img
							src={require('./machine-learning/default_pearson_result.png')}
				...
				<div style={{ display: "flex" }}>
					<div style={{ flex: "50%", padding: 10 }}>
						<img src={require('./machine-learning/default_pearson.png')} alt="default_pearson.png" />
					</div>
					<div style={{ flex: "50%", padding: 10 }}>
						<ul>
				...
				<div style={{ display: "flex" }}>
					<div style={{ flex: "50%", padding: 10 }}>
						<img src={require('./machine-learning/less_data_pearson.png')} alt="less_data_pearson.png" />
					</div>
					<div style={{ flex: "50%", padding: 10 }}>
						<ul>
				...
				<div style={{ display: "flex" }}>
					<div style={{ flex: "50%", padding: 10 }}>
						<img src={require('./machine-learning/linear_regression.png')} alt="linear_regresion.png" />
					</div>
					<div style={{ flex: "50%", padding: 10 }}>
				...
				<div style={{ display: "flex" }}>
					<div style={{ flex: "50%", padding: 10 }}>
						<img src={require('./machine-learning/polynomial_regression.png')} alt="polynomial_regression.png" />
					</div>
					<div style={{ flex: "50%", padding: 10 }}>
				...
				<>
					...
					<p>
						<img src={require('./machine-learning/correlation_room_type.jpg')} alt="correlation_room_type" />
					</p>
					<p>
						<b>Recommendations</b>:
					</p>
					...
					<p>
						<a href={require('./machine-learning/clustering/peer_report_code.ipynb')}
					...
					<p>
						<a
							href={require('./machine-learning/clustering/group3_report.docx')}
				...
				<>
					...
					<p>
						<a href={require('./machine-learning/ann/Team_Presentation_Group_3_Transcript.pdf')} download={'Team_Presentation_Group_3_Transcript.pdf'}>
							Link to transcript
						</a>
					</p>
					<p>
						<a
							href={require('./machine-learning/ann/Team_Presentation_Group_3_Code.ipynb')} download={'Team_Presentation_Group_3_Code.pdf'}
						>
